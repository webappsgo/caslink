...
func (h *AdminHandler) adminNav(activePath string) []adminNavItem {
	...
	items := []adminNavItem{
		...
		{Label: "OIDC Providers", URL: base + "/config/security/auth/oidc", Icon: "🔓"},
		{Label: "LDAP Providers", URL: base + "/config/security/auth/ldap", Icon: "📇"},
		{Label: "SAML Providers", URL: base + "/config/security/auth/saml", Icon: "🎫"},
