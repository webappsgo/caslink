...
// Admin panel HTML templates are parsed once at package init instead of
// per-request, since html/template.Parse is not cheap for large templates.
...
var adminDashboardTmpl = template.Must(template.New("dashboard").Parse(`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
var adminUserListTmpl = template.Must(template.New("userlist").Parse(`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
var adminUserDetailTmpl = template.Must(template.New("userdetail").Parse(`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
var adminRecoveryKeysTmpl = template.Must(template.New("rk").Parse(`<!DOCTYPE html>
