...
// RunBackup packs configDir + dataDir into a single tar.gz under backupDir.
// When explicitDst is non-empty it is used verbatim (treated as an absolute
// or working-dir-relative file path). Otherwise the file is named
// caslink-YYYYMMDD-HHMMSS.tar.gz under backupDir.
