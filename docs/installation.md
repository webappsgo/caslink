...
| Purpose | Path |
|---------|------|
| Config | `~/.config/webappsgo/caslink/` |
| Data | `~/.local/share/webappsgo/caslink/` |
| Logs | `~/.local/state/webappsgo/caslink/logs/` |
...
make dev             # quick local build → $TMPDIR/webappsgo/caslink-*/
